      ...
      <div className="grid grid-cols-3 gap-4 mt-4">
        ...
        <div className="col-span-1">
          ...
          <div className="p-2.5">
            ...
            <div className="flex gap-2">
              <span>
                <img src="call.svg" alt="Location" className="w-6 h-6" />
              </span>
              <p>{user.phone}</p>
            </div>
            <div className="flex gap-2">
              <span>
                <img src="mail.svg" alt="Location" className="w-6 h-6" />
              </span>
              <p>{user.email}</p>
            </div>
          </div>

          <h2 className="text-xl font-medium border-b-2 mt-4">Your Contact</h2>
          <div className="p-2.5">
